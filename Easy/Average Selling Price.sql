...
2-'If SUM(u.units) is 0 (rare, but possible if units can be 0), NULLIF(...,0) avoids division-by-zero and returns NULL → then IFNULL(...,0) returns 0.'
...
3- 'Reduce duplicate scanning (optional for big data)'
